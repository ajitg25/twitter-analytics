...
if is_authenticated():
    ...
    # Initialize API with user's cookies
    api = TwitterLiveAPI(username=username, cookies=cookies)
    ...
    if use_cache and not force_refresh:
        ...
        if not recent_tweets:
            ...
            if st.button("📥 Load Live Metrics", type="primary", use_container_width=True, help="This will fetch your latest 50 tweets and analytics from X"):
                if user_id:
